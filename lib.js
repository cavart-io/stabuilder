...
var assign, build, cleanIndexNames, dive, execSync, fileProps, filterClasses, filterFiles, filterIndexes, fm, fs, listFiles, makeMenu, mdwrapper, menu, noFilter, outdir, parseFM, path, prepareMD, pretty, pug, readFile, render, run, sortBy, srcdir, types, writeHtml;
